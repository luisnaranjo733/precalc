...
From graphing the polar equation :math:`r = 3 -3 \sin x` in radian/function mode, I can tell that the maximum r value is 6 because that is the highest y valu you can ever get on this particulur sinusoid.
